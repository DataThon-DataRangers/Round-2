...
export default function News() {
	...
	return (
		<>
			<h1 className="text-5xl md:text-8xl font-extrabold tracking-tight  mt-32 py-10">
				Latest Health News
			</h1>
			<section className="grid grid-cols-1 md:grid-cols-3 max-w-6xl gap-10">
				{news.map((newsA) => {
					return (
						<>
							<article className="overflow-hidden rounded-2xl bg-slate-200 shadow-md">
								<img
									alt={newsA.title}
