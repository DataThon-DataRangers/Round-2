  ...
  return (
    <section className="bg-background">
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        <section className="relative flex h-[20vh] items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          <img
            alt="Night"
          ...
          <div className="max-w-xl lg:max-w-3xl">
            ...
            <div className="mt-8 flex flex-col justify-center items-start gap-8">
              ...
              <p className="leading-7 max-w-[40ch] ">
                Dont worry, we wont sell your data, we are using it to store
                your chat history for convinience
              </p>
              <button
                onClick={handleClick}
