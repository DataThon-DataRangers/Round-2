        ...
        <>
          ...
          <div className="grid grid-cols-1 w-full max-w-sm place-content-start gap-10 pr-5">
            ...
            <div className=" space-y-3">
              ...
              <Input type="text" id="symptoms" ref={symptomsRef} />
            </div>

            <div className=" space-y-3">
              <Label htmlFor="drasticChange">Any drastic change in life</Label>
              <Input type="text" id="drasticChange" ref={drasticChangeRef} />
            </div>

            <div className=" space-y-3">
              <Label htmlFor="allergies">Allergies</Label>
              <Input type="text" id="allergies" ref={allergiesRef} />
            </div>
            ...
            <div className=" space-y-3">
              ...
              <Input type="text" id="medicalHistory" ref={medicalHistoryRef} />
            </div>
